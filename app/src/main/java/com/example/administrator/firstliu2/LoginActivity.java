...
//                    Toast.makeText(LoginActivity.this, "登录成功", Toast.LENGTH_SHORT).show();
    ...
    private void login() {
        final String cmd = "\"appCmdCode1\":6,\"appCmdCode2\":6,\"account\":\"18800200000\",\"password\":\"123456\"";
        //降低预热
        MyApplication.tcpClient.send(Constants.ACTION_LOGIN, cmd);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (mAction) {
                case Constants.ACTION_LOGIN:
                    ...
                    Toast.makeText(LoginActivity.this, "接收到消息:" + msg, Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LoginActivity.this, MainActivity.class));
                    finish();
                    break;
            }
